...
export default function Smooth3DSlideshow({
    ...
    const handleCardClick = useCallback(
        (i) => {
            ...
            lock();
            if (i === active) {
                if (onActiveClick) onActiveClick(list[i], i);
            } else {
                setActive(i);
            }
        },
        [isStatic, autoplay, n, lock, active, onActiveClick, list]
    );
            ...
            >
                {list.map((slide, i) => {
                    ...
                    const cardStyle = {
                        ...
                        boxShadow: isActive ? "0 25px 50px -12px rgba(212,175,55,0.25)" : "none",
                    };
